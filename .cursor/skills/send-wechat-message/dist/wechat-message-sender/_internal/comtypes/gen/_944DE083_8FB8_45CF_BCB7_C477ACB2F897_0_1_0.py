...
__all__ = [
    'AnnotationType_FormatChange', 'UIA_AnnotationTypesAttributeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_DropTarget_DragLeaveEventId', 'UIA_GridItemPatternId',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_ItemContainerPatternId', 'UIA_RangeValueMaximumPropertyId',
    ...
    'NavigateDirection', 'AutomationElementMode_None',
    'UIA_ToolTipOpenedEventId', 'StyleId_NumberedList',
    'UIA_MenuItemControlTypeId', 'UIA_MenuOpenedEventId',
    'UIA_SemanticZoomControlTypeId', 'ZoomUnit_SmallIncrement',
    'UIA_LegacyIAccessibleStatePropertyId', 'TreeScope',
    'UIA_StrikethroughStyleAttributeId',
    'TreeTraversalOptions_LastToFirstOrder', 'AnnotationType_Author',
    'UIA_ObjectModelPatternId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_ButtonControlTypeId', 'UIA_HelpTextPropertyId',
    'AnnotationType_SpellingError', 'UIA_ControlTypePropertyId',
    'UIA_DataGridControlTypeId', 'UIA_StylesStyleNamePropertyId',
    'IUIAutomationTreeWalker', 'UIA_AnimationStyleAttributeId',
    'UIA_IsStylesPatternAvailablePropertyId', 'HeadingLevel4',
    'WindowVisualState_Minimized',
    'UIA_IsTablePatternAvailablePropertyId',
    'IUIAutomationNotificationEventHandler', 'DockPosition_None',
    'IUIAutomationTransformPattern',
    'IUIAutomationSelectionItemPattern', 'UIA_AppBarControlTypeId',
    'IUIAutomationEventHandlerGroup', 'UIA_GroupControlTypeId',
    'UIA_IsSubscriptAttributeId', 'AnnotationType_Comment',
    'UIA_CapStyleAttributeId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_StyleNameAttributeId',
    'UIA_LabeledByPropertyId', 'RowOrColumnMajor',
    'UIA_SeparatorControlTypeId', 'IUIAutomation',
    'UIA_DragGrabbedItemsPropertyId',
    'WindowInteractionState_Closing', 'UIA_VirtualizedItemPatternId',
    'UIA_DragIsGrabbedPropertyId', 'TreeTraversalOptions',
    'UIA_SpreadsheetPatternId', 'UIA_RangeValueSmallChangePropertyId',
    'IUIAutomationChangesEventHandler',
    'UIA_ValueIsReadOnlyPropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'IUIAutomationTextPattern2', 'UIA_HeaderControlTypeId',
    'UIA_ExpandCollapsePatternId', 'HeadingLevel7',
    'IUIAutomationDragPattern', 'UIA_TransformCanResizePropertyId',
    'AnnotationType_Endnote', 'UIA_IsTextPatternAvailablePropertyId',
    'UIA_SelectionSelectionPropertyId', 'UIA_TransformPattern2Id',
    'UIA_OutlineStylesAttributeId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'IUIAutomationTransformPattern2', 'UIA_RangeValueValuePropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_ToolTipControlTypeId', 'Off',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'NotificationProcessing_All', 'NotificationKind_ItemAdded',
    'UIA_MenuBarControlTypeId', 'UIA_SplitButtonControlTypeId',
    'CUIAutomation8', 'AnnotationType_Footnote',
    'UIA_LegacyIAccessibleRolePropertyId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_HyperlinkControlTypeId',
    ...
    'UIA_SizePropertyId', 'UIA_MarginLeadingAttributeId',
    'UIA_SpreadsheetItemPatternId',
    'ProviderOptions_ServerSideProvider',
    'IUIAutomationPropertyCondition', 'UIA_CaretPositionAttributeId',
    ...
    'UIA_ClickablePointPropertyId', 'UIA_LandmarkTypePropertyId',
    'UIA_IsContentElementPropertyId', 'UIA_IsItalicAttributeId',
    'DockPosition', 'UIA_CaretBidiModeAttributeId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_OptimizeForVisualContentPropertyId',
    'IUIAutomationTablePattern', 'ZoomUnit', 'StyleId_Heading9',
    'AnnotationType_TrackChanges', 'UIA_WindowIsTopmostPropertyId',
    'UIA_MenuModeStartEventId', 'UIA_SelectionActiveEndAttributeId',
    'IUIAutomationAnnotationPattern', 'UIA_TransformPatternId',
    'UIA_IsInvokePatternAvailablePropertyId', 'UIA_ValuePatternId',
    'TextUnit_Format', 'IUIAutomationCustomNavigationPattern',
    'UIA_IsReadOnlyAttributeId', 'TextPatternRangeEndpoint_End',
    'UIA_OutlineColorPropertyId', 'UIA_TabItemControlTypeId',
    'UIA_BoundingRectanglePropertyId', 'UIA_SelectionPatternId',
    'TreeScope_None', 'NotificationKind_ActionAborted',
    'ConnectionRecoveryBehaviorOptions',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_AnnotationPatternId',
    'UIA_IsTextPattern2AvailablePropertyId', 'NotificationProcessing',
    ...
    'UIA_SayAsInterpretAsAttributeId', 'WindowVisualState_Normal',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'IUIAutomationNotCondition',
    'IUIAutomationVirtualizedItemPattern', 'StyleId_Heading6',
    'IUIAutomationLegacyIAccessiblePattern', 'UIA_DragPatternId',
    'UIA_ToolBarControlTypeId', 'UIA_IsOffscreenPropertyId',
    'TreeScope_Ancestors', 'UIA_GridColumnCountPropertyId',
    'UIA_FontSizeAttributeId', 'ExtendedProperty',
    'IUIAutomationSelectionPattern', 'SynchronizedInputType',
    'UIA_Drag_DragStartEventId', 'UIA_Window_WindowOpenedEventId',
    'RowOrColumnMajor_ColumnMajor', 'HeadingLevel_None',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_MarginTopAttributeId', 'TextUnit', 'StyleId_Heading5',
    'UIA_TextControlTypeId', 'StructureChangeType',
    'UIA_IsDataValidForFormPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'IUIAutomationBoolCondition', 'OrientationType_Horizontal',
    'UIA_TabsAttributeId', 'UIA_InvokePatternId',
    'IUIAutomationElement4', 'UIA_TogglePatternId',
    'UIA_ActiveTextPositionChangedEventId', 'SupportedTextSelection',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'HeadingLevel6',
    'UIA_MenuControlTypeId', 'UIA_SizeOfSetPropertyId',
    'UIA_AnnotationAuthorPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'CoalesceEventsOptions_Enabled',
    'UIA_WindowCanMaximizePropertyId',
    'UIA_UnderlineStyleAttributeId', 'TextUnit_Word',
    'UIA_AutomationIdPropertyId', 'UIA_CustomLandmarkTypeId',
    'IUIAutomationScrollPattern', 'IUIAutomationScrollItemPattern',
    'IUIAutomationTextRange3',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_AccessKeyPropertyId', 'UIA_FlowsFromPropertyId',
    'IUIAutomation3', 'OrientationType_Vertical',
    'ScrollAmount_LargeIncrement', 'AutomationElementMode_Full',
    'ScrollAmount_LargeDecrement', 'UIA_LayoutInvalidatedEventId',
    'UIA_SayAsInterpretAsMetadataId',
    'UIA_AutomationFocusChangedEventId', 'UIA_ListItemControlTypeId',
    'UIA_ListControlTypeId', 'UIA_SelectionPattern2Id',
    ...
    'UIA_ClassNamePropertyId', 'UIA_AnnotationTargetPropertyId',
    'UIA_StylesPatternId', 'Polite', 'UIA_FullDescriptionPropertyId',
    'PropertyConditionFlags_None',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationTogglePattern',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_OverlineStyleAttributeId', 'UIA_CustomControlTypeId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_WindowIsModalPropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_IsSuperscriptAttributeId', 'UIA_TreeItemControlTypeId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'NotificationProcessing_ImportantAll', 'UIA_WindowPatternId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'ProviderOptions_UseClientCoordinates',
    'IUIAutomationMultipleViewPattern', 'UIA_AriaRolePropertyId',
    'UIA_GridItemRowSpanPropertyId', 'UIA_EditControlTypeId',
    'TreeScope_Parent', 'UIA_LegacyIAccessiblePatternId',
    'DockPosition_Bottom',
    ...
    'AnnotationType_Sensitive', 'UIA_Transform2CanZoomPropertyId',
    'NotificationKind', 'UIA_IsTextChildPatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseUp', 'UIA_MultipleViewPatternId',
    'UIA_DragDropEffectPropertyId', 'UIA_NotificationEventId',
    'AnnotationType_ConflictingChange', 'StyleId_Custom',
    'IUIAutomationCondition', 'UIA_LegacyIAccessibleNamePropertyId',
    'WindowVisualState_Maximized', 'UiaChangeInfo',
    'UIA_BeforeParagraphSpacingAttributeId',
    'IUIAutomationDropTargetPattern', 'AnnotationType_Header',
    'IUIAutomationTextEditPattern', 'UIA_TableItemPatternId',
    'UIA_LiveRegionChangedEventId', 'IUIAutomationOrCondition',
    'UIA_AnnotationObjectsPropertyId', 'IAccessible',
    'IUIAutomationProxyFactory', 'TextPatternRangeEndpoint_Start',
    'HeadingLevel2', 'UIA_SelectionItemSelectionContainerPropertyId',
    'IUIAutomationCacheRequest', 'UIA_CalendarControlTypeId',
    'UIA_RangeValuePatternId', 'IUIAutomationElement7',
    'UIA_AsyncContentLoadedEventId', 'UIA_TextEditPatternId',
    'IUIAutomationStylesPattern', 'ProviderOptions_OverrideProvider',
    'UIA_StrikethroughColorAttributeId',
    'PropertyConditionFlags_MatchSubstring',
    'AnnotationType_FormulaError', 'UIA_DataItemControlTypeId',
    'TextEditChangeType_AutoCorrect', 'ToggleState', 'ScrollAmount',
    'UIA_CustomNavigationPatternId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_IsHiddenAttributeId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_RuntimeIdPropertyId', 'UIA_AriaPropertiesPropertyId',
    'UIA_Transform2ZoomLevelPropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'RowOrColumnMajor_RowMajor', 'AnnotationType_Unknown',
    'typelib_path', 'TreeTraversalOptions_PostOrder',
    'UIA_Transform2ZoomMaximumPropertyId', 'StyleId_Heading8',
    'CoalesceEventsOptions_Disabled', 'UIA_FlowsToPropertyId',
    'TextUnit_Document', 'UIA_ForegroundColorAttributeId',
    'UIA_OrientationPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'TextUnit_Paragraph',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_ChangesEventId', 'UIA_Text_TextChangedEventId',
    'ExpandCollapseState_LeafNode', 'UIA_ItemStatusPropertyId',
    ...
    'StructureChangeType_ChildrenReordered', 'UIA_MenuClosedEventId',
    'AnnotationType_Footer', 'ProviderOptions',
    'UIA_FontWeightAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationDockPattern', 'UIA_SynchronizedInputPatternId',
    'UIA_SelectionItemPatternId', 'UIA_ProgressBarControlTypeId',
    'UIA_OutlineThicknessPropertyId', 'WindowInteractionState',
    ...
    'IUIAutomationExpandCollapsePattern', 'StyleId_Subtitle',
    'UIA_HostedFragmentRootsInvalidatedEventId', 'StyleId_Title',
    'AnnotationType_InsertionChange', 'UIA_CenterPointPropertyId',
    'UIA_LineSpacingAttributeId', 'UIA_CultureAttributeId',
    'StyleId_Emphasis', 'UIA_SearchLandmarkTypeId',
    'UIA_ComboBoxControlTypeId', 'RowOrColumnMajor_Indeterminate',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'AutomationElementMode', 'UIA_SummaryChangeId',
    'UIA_FillTypePropertyId', 'UIA_DockPatternId', 'StyleId_Heading1',
    'TreeTraversalOptions_Default', 'IUIAutomationElement8',
    'ScrollAmount_SmallDecrement', 'AnnotationType_UnsyncedChange',
    'IUIAutomationObjectModelPattern', 'UIA_GridItemColumnPropertyId',
    'Assertive', 'UIA_InputReachedTargetEventId', 'Library',
    'UIA_VisualEffectsPropertyId', 'IUIAutomationAndCondition',
    'UIA_TransformCanRotatePropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'IUIAutomationGridPattern', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_ControllerForPropertyId',
    'WindowInteractionState_NotResponding', 'UIA_IsActiveAttributeId',
    ...
    'ZoomUnit_SmallDecrement', 'ProviderOptions_UseComThreading',
    'IUIAutomationTextRange2', 'UIA_IndentationLeadingAttributeId',
    'UIA_AnnotationObjectsAttributeId', 'UIA_FormLandmarkTypeId',
    'IUIAutomationElementArray', 'StyleId_Heading3',
    'UIA_TextPattern2Id', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_RotationPropertyId', 'IUIAutomationSelectionPattern2',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'TextEditChangeType_CompositionFinalized',
    'ProviderOptions_RefuseNonClientSupport',
    'NavigateDirection_NextSibling',
    'UIA_IsScrollPatternAvailablePropertyId', 'StyleId_Normal',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'NotificationKind_ItemRemoved', 'TreeScope_Children',
    'ScrollAmount_SmallIncrement',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_ImageControlTypeId', 'TextEditChangeType',
    ...
    'UIA_DropTarget_DragEnterEventId', 'UIA_StylesStyleIdPropertyId',
    'StyleId_Heading7', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'DockPosition_Fill',
    'AnnotationType_DeletionChange',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_LiveSettingPropertyId',
    'ExpandCollapseState', 'UIA_ValueValuePropertyId',
    'UIA_DocumentControlTypeId', 'UIA_UnderlineColorAttributeId',
    'IUIAutomationSpreadsheetPattern',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_DescribedByPropertyId', 'OrientationType_None',
    'IUIAutomationRangeValuePattern',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_SystemAlertEventId', 'UIA_StylesFillColorPropertyId',
    'UIA_DropTarget_DroppedEventId', 'CoalesceEventsOptions',
    'StructureChangeType_ChildAdded', 'UIA_SliderControlTypeId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_StylesShapePropertyId', 'UIA_Invoke_InvokedEventId',
    'UIA_InputReachedOtherElementEventId',
    'ToggleState_Indeterminate', 'StructureChangeType_ChildRemoved',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_RangeValueMinimumPropertyId', 'DockPosition_Top',
    'IUIAutomationElement', 'UIA_TextPatternId', 'UIA_GridPatternId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'ExpandCollapseState_PartiallyExpanded', 'IUIAutomation6',
    'IRawElementProviderSimple', 'UIA_WindowControlTypeId',
    'ExpandCollapseState_Expanded', 'UIA_ToggleToggleStatePropertyId',
    'UIA_FontNameAttributeId', 'ZoomUnit_LargeIncrement',
    'UIA_ToolTipClosedEventId', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_ScrollPatternId', 'OrientationType',
    'UIA_TextChildPatternId', 'ScrollAmount_NoAmount',
    'AnnotationType_EditingLockedChange',
    'UIA_Drag_DragCompleteEventId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_MarginBottomAttributeId', 'LiveSetting',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_AnnotationTypesPropertyId', 'UIA_TabControlTypeId',
    'ZoomUnit_NoAmount', 'IUIAutomationValuePattern', 'HeadingLevel3',
    'ToggleState_Off', 'UIA_ScrollItemPatternId',
    'UIA_StatusBarControlTypeId', 'UIA_DropTargetPatternId',
    'UIA_PaneControlTypeId', 'HeadingLevel5',
    'TextEditChangeType_AutoComplete', 'UIA_NavigationLandmarkTypeId',
    'TextEditChangeType_None', 'PropertyConditionFlags',
    'SupportedTextSelection_Multiple',
    'UIA_BackgroundColorAttributeId',
    'UIA_IsDragPatternAvailablePropertyId',
    'SynchronizedInputType_RightMouseUp',
    'IUIAutomationProxyFactoryEntry', 'ExpandCollapseState_Collapsed',
    'IUIAutomationTextRangeArray', 'SupportedTextSelection_None',
    ...
    'IUIAutomationTextPattern', 'UIA_LinkAttributeId',
    'UIA_FillColorPropertyId', 'StyleId_Quote',
    'IUIAutomationEventHandler', 'UIA_OverlineColorAttributeId',
    'UIA_LegacyIAccessibleValuePropertyId', 'WindowVisualState',
    'UIA_PositionInSetPropertyId',
    'UIA_IsGridPatternAvailablePropertyId',
    'ProviderOptions_NonClientAreaProvider', 'StyleId_BulletedList',
    'ConnectionRecoveryBehaviorOptions_Disabled', 'HeadingLevel8',
    'IUIAutomationElement2',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_DockDockPositionPropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_IndentationTrailingAttributeId',
    'StructureChangeType_ChildrenBulkAdded', 'StyleId_Heading2',
    'IUIAutomation4', 'NotificationProcessing_MostRecent',
    'IUIAutomationInvokePattern', 'IUIAutomation5',
    'AnnotationType_Highlighted', 'AnnotationType_GrammarError',
    'TreeScope_Descendants', 'UIA_TableControlTypeId',
    'UIA_ProcessIdPropertyId', 'UIA_TitleBarControlTypeId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'AnnotationType_DataValidationError',
    'AnnotationType_CircularReferenceError',
    'UIA_IsRequiredForFormPropertyId', 'IUIAutomationElement6',
    'UIA_TreeControlTypeId', 'TextUnit_Character',
    ...
    'UIA_IsPeripheralPropertyId', 'IUIAutomationTextRange',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_NativeWindowHandlePropertyId', 'DockPosition_Left',
    'UIA_TransformCanMovePropertyId', 'DockPosition_Right',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_SelectionItemIsSelectedPropertyId',
    'NavigateDirection_LastChild', 'IUIAutomationElement3',
    'UIA_ItemTypePropertyId', 'HeadingLevel9', 'UIA_NamePropertyId',
    'UIA_StylesExtendedPropertiesPropertyId', 'UIA_TablePatternId',
    'UIA_MainLandmarkTypeId', 'TreeScope_Subtree',
    'UIA_IsControlElementPropertyId', 'SynchronizedInputType_KeyDown',
    'UIA_IsEnabledPropertyId', 'UIA_TableColumnHeadersPropertyId',
    'UIA_DragDropEffectsPropertyId', 'UIA_GridRowCountPropertyId',
    'UIA_Window_WindowClosedEventId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_InputDiscardedEventId', 'UIA_CheckBoxControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_ScrollBarControlTypeId',
    'UIA_SelectionItem_ElementSelectedEventId', 'TreeScope_Element',
    'TextUnit_Page', 'UIA_ScrollHorizontalViewSizePropertyId',
    'IUIAutomationWindowPattern', 'UIA_CulturePropertyId',
    'TextPatternRangeEndpoint', 'UIA_StyleIdAttributeId',
    'UIA_ThumbControlTypeId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_MultipleViewCurrentViewPropertyId', 'HeadingLevel1',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_AfterParagraphSpacingAttributeId', 'NotificationKind_Other',
    'IUIAutomationItemContainerPattern',
    'IUIAutomationTextChildPattern', 'UIA_StructureChangedEventId'
]

_check_version('1.4.16', 1748038017.384747)
